...
*/
        ...
        <div layout="row" layout-align="center center" class="md-padding gradientBg">
            <div flex layout="column" layout-align="center center">
                ...
                <div layout="row"  layout-align="center center" class="md-padding">
                    <md-button class="md-raised md-warn md-padding" ng-click="triggerLanding()" style="width: 250px; height: 50px;" layout="row" layout-align="center center">
                        <span flex></span>
    ...
    <div layout="row" layout-align="center center"><a href="mailto:contact@tableenville.com">contact@tableenville.com</a> | &copy; 2017 Table en Ville | all rights reserved |&nbsp; <i class="fa fa-instagram" aria-hidden="true"></i>&nbsp;<i class="fa fa-facebook" aria-hidden="true"></i>&nbsp;<i class="fa fa-twitter" aria-hidden="true"></i>&nbsp;<br /><br /></div>
        ...
        <form name="LandingForm" layout="column">
            <md-toolbar class="md-primary" style="opacity: 0.5;">
                <div class="md-toolbar-tools">
                    <h2 md-colors="{color: 'primary-50'}">Coming soon...</h2>
                    <span flex></span>
            ...
            <div layout="row" layout-xs="column" layout-align="center center" class="md-padding"> 
                <div flex-gt-xs="50" layout="column"  md-colors="{fill: 'accent-800'}" layout-align="center center">
